...
check(template.includes('class="calc-field-scope-note"') && template.includes('방어·판별') && template.includes('회복 도구'), 'calculator declares power scope and healing-item KO policy');
