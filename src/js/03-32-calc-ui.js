...
function powerUiMovePresentation(slot, calc, calculated = powerUiCalculateSlot(slot,calc)) {
  ...
  return {
    powerMarkup, moveButton, pickerContent, damage, koMarkup,
