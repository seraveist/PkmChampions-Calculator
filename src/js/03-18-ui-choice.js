...
let bind0318UiChoiceBound = false;
function bind0318UiChoice() {
  if (bind0318UiChoiceBound) return;
  bind0318UiChoiceBound = true;
  (() => {
...
export { bind0318UiChoiceBound, bind0318UiChoice };
